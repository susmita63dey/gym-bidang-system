...
$stmt = $DB_con->prepare("SELECT * FROM news where news_id=$news_id");
$stmt->execute();
$data=$stmt->fetch(PDO::FETCH_ASSOC);

$stmt = $DB_con->prepare("SELECT * FROM news_photo where news_id=$news_id");
$stmt->execute();
$data1=$stmt->fetchAll();
?>
<!doctype html>
...
<head>
<title>Bidang MMA & Fitness Gym || Update Details</title>
<!--meta info-->
<meta charset="utf-8">
							...
							<div class="row">
								<div class="col-md-9">
									<ul>
										...
										<li><span>//</span></li>
										<li class="category-1"><a href="updates.php">Updates</a></li>
										<li><span>//</span></li>
										<li class="category-2">Update details</li>								
									</ul>
								</div>
							</div>	
						</div>
								...
								<div class="col-lg-12 col-md-8 col-sm-12 col-xs-12">
									<div class="event-listing">		
										<div class="event-content">
											<div class="img-event">
												<img src="bidang-admin/images/news-banner/<?php echo $data['photo'] ?>" alt=""/>
											</div>
											<div class="news-item-inner">
												<div class="news-date">
													<div class="news-day"><?php echo date("j", strtotime($data['news_date'])); ?></div>
													<div class="news-month"><?php echo date("M", strtotime($data['news_date'])); ?></div>
												</div>
												<div class="news-info">
													<div class="news-title">
														<?php echo $data['news_name']; ?>
													</div>
													<!-- <div class="news-time">
								...
								<section id="our-class-main" class="isotope">
									<?php foreach ($data1 as $row1) { ?>
										<div class="mix sport boxing element-item col-xs-12 col-sm-6 col-md-3" data-category="sport" style="padding-right: 0px; padding-left: 0px;">
											<div class="box-inner">
												<a class="example-image-link" href="bidang-admin/images/news-photos/<?php echo $row1['event_photo'] ?>" data-lightbox="example-set" data-title="">
													<img src="bidang-admin/images/news-photos/<?php echo $row1['event_photo'] ?>" alt=""/>
												</a>
											</div>
										</div>
									<?php } ?>
