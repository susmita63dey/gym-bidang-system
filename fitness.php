...
<head>
<title>Bidang MMA & Fitness Gym || Fitness</title>
<!--meta info-->
<meta charset="utf-8">
...
<link rel="stylesheet" type="text/css" media="all" href="dist/css/lightbox.min.css">
				...
				<ul class="nav-menu">
					...
					<li class="dropdown">
						...
						<ul class="child-nav dropdown-nav">
							...
							<li class="selected active"><a href="fitness.php">Fitness</a></li>
							...
							<div class="row">
								<div class="col-md-9">
									<ul>
										...
										<li><span>//</span></li>
										<li class="category-1"><a href="#">Programs</a></li>
										<li><span>//</span></li>
										<li class="category-2">Fitness</li>								
									</ul>
								</div>
							</div>	
						</div>
								...
								<div class="container">
									<div class="row">
										<div class="boxing-content">
															...
															<div id="carousel" class="carousel slide" data-ride="carousel">											
																...
																<div class="carousel-inner" role="listbox">
																	<!-- <div class="item active">
																		<img src="images/bg-blog-6.jpg" alt=""/>
																	</div>
																	 -->
																	<div class="item active">
																		<img src="images/bg-blog-7.jpg" alt=""/>
																	</div>												
																</div>
											...
											<div class="reviews-content col-md-4 col-sm-12 col-xs-12">
														<div class="match-reviews match col-md-12 col-sm-12 col-xs-12">
															<h3>OUR Fitness PROGRAM</h3>
															<div class="border"></div>
															<p style="padding-left: 30px; padding-right: 10px; text-align:justify;">
																To be healthy and to feel great you need physical exercise. Our fitness 
																training programs include both a resistance and an endurance training 
																component. We offer a series of classes such as Functional Training, 
																Strength & Conditioning, Crossfit and much more. You can also access 
																the regular gym with their certified trainers and equipment.</p>
								...
								<div class="sevices-main">
									...
									<div class="col-md-3 col-sm-6 col-xs-12">
										<div class="sevices-wapper">	
											<div class="services-content">
												<div class="intro-img">
													<img src="images/icons/functional-training.png" alt=""/>
												</div>
												<h4 class="services-title">Functional Training</h4>
									...
									<div class="col-md-3 col-sm-6 col-xs-12">
										<div class="sevices-wapper">	
											<div class="services-content">
												<div class="intro-img">
													<img src="images/icons/hiit-training.png" alt=""/>
												</div>
												<h4 class="services-title">HIIT Training</h4>
												<hr  class="border-title-1">
											</div>									
										</div>									
									</div>
									<div class="col-md-3 col-sm-6 col-xs-12">
										<div class="sevices-wapper">	
											<div class="services-content">
												<div class="intro-img">
													<img src="images/icons/kettle-bell.png" alt=""/>
												</div>
												<h4 class="services-title">Kettle Bell Classes</h4>
												<hr  class="border-title-1">
											</div>										
										</div>
									</div>
									<div class="col-md-3 col-sm-6 col-xs-12">
										<div class="sevices-wapper">	
											<div class="services-content">
												<div class="intro-img">
													<img src="images/icons/abt.png" alt=""/>
												</div>
												<h4 class="services-title">ABT Classes</h4>
												<hr  class="border-title-1">
											</div>										
										</div>
									</div>
									<div class="col-md-3 col-sm-6 col-xs-12">
										<div class="sevices-wapper">	
											<div class="services-content">
												<div class="intro-img">
													<img src="images/icons/strength-conditioning.png" alt=""/>
												</div>
												<h4 class="services-title">Strength & Conditioning</h4>
												<hr  class="border-title-1">
											</div>										
										</div>
									</div>
									<div class="col-md-3 col-sm-6 col-xs-12">
										<div class="sevices-wapper">	
											<div class="services-content">
												<div class="intro-img">
													<img src="images/icons/endurance.png" alt=""/>
												</div>
												<h4 class="services-title">Endurance</h4>
												<hr  class="border-title-1">
											</div>										
										</div>
									</div>
									<div class="col-md-3 col-sm-6 col-xs-12">
										<div class="sevices-wapper">	
											<div class="services-content">
												<div class="intro-img">
													<img src="images/icons/power-barbell.png" alt=""/>
												</div>
												<h4 class="services-title">power barbell</h4>
												<hr  class="border-title-1">
											</div>								
										</div>
									</div>
									...
									<div class="col-md-3 col-sm-6 col-xs-12">
										<div class="sevices-wapper">	
											<div class="services-content">
												<div class="intro-img">
													<img src="images/icons/cardio.png" alt=""/>
												</div>
												<h4 class="services-title">Cardio Training</h4>
												<hr  class="border-title-1">
											</div>								
										</div>
									</div>
									...
									<div class="col-md-3 col-sm-6 col-xs-12">
										<div class="sevices-wapper">	
											<div class="services-content">
												<div class="intro-img">
													<img src="images/icons/sports-fitness.png" alt=""/>
												</div>
												<h4 class="services-title">sports/Athelete Fitness</h4>
												<hr  class="border-title-1">
											</div>								
										</div>
									</div>
									...
									<div class="col-md-3 col-sm-6 col-xs-12">
										<div class="sevices-wapper">	
											<div class="services-content">
												<div class="intro-img">
													<img src="images/icons/crossfit.png" alt=""/>
												</div>
												<h4 class="services-title">crossfit</h4>
												<hr  class="border-title-1">
											</div>								
										</div>
									</div>
									<div class="col-md-3 col-sm-6 col-xs-12">
										<div class="sevices-wapper">	
											<div class="services-content">
												<div class="intro-img">
													<img src="images/icons/outdoor-training.png" alt=""/>
												</div>
												<h4 class="services-title">Outdoor Training</h4>
												<hr  class="border-title-1">
											</div>								
										</div>
									</div>
									<div class="col-md-3 col-sm-6 col-xs-12">
										<div class="sevices-wapper">	
											<div class="services-content">
												...
												<h4 class="services-title">Diet & Nutrition</h4>
												<hr  class="border-title-1">
											</div>								
										</div>
									</div>
						...
						<div class="parallax-block-wrap-module auto-width">
							<div class="parallax-block bt-advance-parallax" id="parallax-block">
								...
								<div class="parallax-block-content default-pos parallax-text parallax-v2">									
										...
										<p class="strart-your">Do you want to become fit</p>
										<h1 class="training-title">START YOUR TRAINING TODAY</h1>
							...
							<div class="row">
								<div id="our-listing-grid" class="our-trainers event-listing-grid">
									<div class="title-page title-about" style="padding-top:5px;">
											<h3>portfolio of <span style="color:#ec3642;"> Fitness</span> program</h3>
										...
										<div class="product-image-wrapper">
											<div class="product-content">
												<div class="product-image product-trainer">
													<a class="example-image-link" href="images/fitness/fitness1.jpg" data-lightbox="example-set" data-title="">
														<img alt="" src="images/fitness/fitness1.jpg">
													</a>
												</div>										
											</div>																																											
										</div>																																											
									...
									<div class="listing-grid col-md-3 col-sm-6 col-xs-12" style="padding-right:5px; padding-left:5px;">
										<div class="product-image-wrapper">
											<div class="product-content">
												<div class="product-image product-trainer">
													<a class="example-image-link" href="images/fitness/fitness2.jpg" data-lightbox="example-set" data-title="">
														<img alt="" src="images/fitness/fitness2.jpg">
													</a>
												</div>											
											</div>																																											
										</div>																																											
									...
									<div class="listing-grid col-md-3 col-sm-6 col-xs-12" style="padding-right:5px; padding-left:5px;">
										<div class="product-image-wrapper">
											<div class="product-content">
												<div class="product-image product-trainer">
													<a class="example-image-link" href="images/fitness/fitness3.jpg" data-lightbox="example-set" data-title="">
														<img alt="" src="images/fitness/fitness3.jpg">
													</a>
												</div>										
											</div>																																											
										</div>																																											
									...
									<div class="listing-grid col-md-3 col-sm-6 col-xs-12" style="padding-right:5px; padding-left:5px;">
										<div class="product-image-wrapper">
											<div class="product-content">
												<div class="product-image product-trainer">
													<a class="example-image-link" href="images/fitness/fitness8.jpg" data-lightbox="example-set" data-title="">
														<img alt="" src="images/fitness/fitness8.jpg">
													</a>
												</div>											
											</div>																																											
										</div>																																											
									...
									<div class="listing-grid col-md-3 col-sm-6 col-xs-12" style="padding-right:5px; padding-left:5px;">
										<div class="product-image-wrapper">
											<div class="product-content">
												<div class="product-image product-trainer">
													<a class="example-image-link" href="images/fitness/fitness5.jpg" data-lightbox="example-set" data-title="">
														<img alt="" src="images/fitness/fitness5.jpg">
													</a>
												</div>											
											</div>																																											
										</div>																																											
									...
									<div class="listing-grid col-md-3 col-sm-6 col-xs-12" style="padding-right:5px; padding-left:5px;">
										<div class="product-image-wrapper">
											<div class="product-content">
												<div class="product-image product-trainer">
													<a class="example-image-link" href="images/fitness/fitness6.jpg" data-lightbox="example-set" data-title="">
														<img alt="" src="images/fitness/fitness6.jpg">
													</a>
												</div>										
											</div>																																											
										</div>																																											
									...
									<div class="listing-grid col-md-3 col-sm-6 col-xs-12" style="padding-right:5px; padding-left:5px;">
										<div class="product-image-wrapper">
											<div class="product-content">
												<div class="product-image product-trainer">
													<a class="example-image-link" href="images/fitness/fitness4.jpg" data-lightbox="example-set" data-title="">
														<img alt="" src="images/fitness/fitness4.jpg">
													</a>
												</div>											
											</div>																																											
										</div>																																											
									...
									<div class="listing-grid col-md-3 col-sm-6 col-xs-12" style="padding-right:5px; padding-left:5px;">
										<div class="product-image-wrapper">
											<div class="product-content">
												<div class="product-image product-trainer">
													<a class="example-image-link" href="images/fitness/fitness7.jpg" data-lightbox="example-set" data-title="">
														<img alt="" src="images/fitness/fitness7.jpg">
													</a>
												</div>											
											</div>																																											
										</div>																																											
