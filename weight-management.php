...
<head>
<title>Bidang MMA & Fitness Gym || Weight Management</title>
<!--meta info-->
<meta charset="utf-8">
		...
		<section  class="page page-category">
				...
				<ul class="nav-menu">
					...
					<li class="dropdown">
						...
						<ul class="child-nav dropdown-nav">
							...
							<li class="selected active"><a href="weight-management.php">Weight Management</a></li>
			...
			<div class="content-wrapper">
				...
				<div class="page-content">					
							...
							<div class="row">
								<div class="col-md-9">
									<ul>
										...
										<li><span>//</span></li>
										<li class="category-2">Weight Management</li>								
									</ul>
								</div>
							</div>	
						</div>
					...
					<!-- End Breadcrumbs -->
					<!--Coming Event-->
					<section class="scroll-to coming-event">
										...
										<div class="boxing-content">
											<div class="col-main col-md-12 col-sm-12 col-xs-12">
												<div class="event-box">
													...
													<div class="reviews-content col-md-12 col-sm-12 col-xs-12">
														<div class="match-img col-md-5 col-sm-6 col-xs-12" style="padding-left:0px;">
															<img src="images/boxing/match-2.jpg" alt=""/>
														</div>
														<div class="match-reviews col-md-7 col-sm-6 col-xs-12">
															<h2>Our Weight Management Program</h2>
															<div class="border"></div>
															<p>If you're trying to manage your weight, our weight management workout plan can be very helpful. 
																Our weight management plan consists of both cardiovascular exercise and resistance training. 
																So, start your training today at our well-equipped gym with our certified trainers.</p>
														</div>							
													</div>
												</div>
											</div>
											...
											<div class="row">
												<div class="col-md-6 col-sm-12 col-xs-12">
													<div class="block-left">
														<div class="about-img">
															<img src="images/weight-management.png" alt=""/>
														</div>
														<div class="about-title">
															<h3>Our Weight Management Program</h3>
														</div>
														...
														<div class="block-right-info">
															<div class="about-info">
																<div class="about-details">
																	<h5 class="about-details-title" style="font-size: 21px;">WEIGHT LOSS WORKOUT PLAN: CARDIO</h5>
																	<p>
															...
															<div class="about-info">
																<div class="about-details">
																	<h4 class="about-details-title" style="font-size: 21px;">WEIGHT LOSS WORKOUT PLAN: RESISTANCE EXERCISE</h4>
																	<p>
																	Consectetur adipiscing elit. Pellentesque ut mollis lectus. Ut ultricies lacinia feugiat. 
																	Cras sed enim quis nunc condimentum ullamcorper.
																	</p>
															...
															<div class="about-info">
																<div class="about-details">
																	<h4 class="about-details-title" style="font-size: 21px;">FITNESS LEVEL: BEGINNER TO ADVANCED WORKOUT PLANS</h4>
																	<p>
																	Consectetur adipiscing elit. Pellentesque ut mollis lectus. Ut ultricies lacinia feugiat. 
																	Cras sed enim quis nunc condimentum ullamcorper.
						...
						<div class="parallax-block-wrap-module auto-width">
							<div class="parallax-block bt-advance-parallax" id="parallax-block">
								...
								<div class="parallax-block-content default-pos parallax-text parallax-v2">									
										...
										<p class="strart-your">Do you want to manage your weight</p>
							...
							<div class="row">
								<div id="our-listing-grid" class="our-trainers event-listing-grid">
									<div class="title-page title-about" style="padding-top:5px;">
											<h3>our <span style="color:#ec3642;"> others</span> programs</h3>
											
										</div>
									<div class="listing-grid col-md-4 col-sm-6 col-xs-12" style="padding-right:5px; padding-left:5px;">
										<div class="product-image-wrapper">
											<div class="product-content">
												<div class="product-image product-trainer">
													<a class="example-image-link" href="mma.php">
														<img alt="" src="images/mma_1.jpg">
													</a>
												</div>
									...
									<div class="listing-grid col-md-4 col-sm-6 col-xs-12" style="padding-right:5px; padding-left:5px;">
										<div class="product-image-wrapper">
											<div class="product-content">
												<div class="product-image product-trainer">
													<a class="example-image-link" href="fitness.php" >
														<img alt="" src="images/fitness_1.jpg">
													</a>
												</div>											
												<div class="info-products">
													<div class="product-name" >
									...
									<div class="listing-grid col-md-4 col-sm-6 col-xs-12" style="padding-right:5px; padding-left:5px;">
										<div class="product-image-wrapper">
											<div class="product-content">
												<div class="product-image product-trainer">
													<a class="example-image-link" href="self-defense.php">
														<img alt="" src="images/self_defense_1.jpg">
													</a>
												</div>
												<div class="info-products">
													<div class="product-name" >
