...
$stmt = $DB_con->prepare("SELECT * FROM club_war where war_id=$war_id");
$stmt->execute();
$data=$stmt->fetch(PDO::FETCH_ASSOC);

$stmt = $DB_con->prepare("SELECT * FROM war_image where war_id=$war_id");
$stmt->execute();
$data1=$stmt->fetchAll();
?>
<!doctype html>
								...
								<div class="col-lg-12 col-md-8 col-sm-12 col-xs-12">
									<div class="event-listing">	
										<div class="event-content">
											<div class="img-event">
												<img src="bidang-admin/images/war/<?php echo $data['photo'] ?>" alt=""/>
											</div>
											<div class="news-item-inner">
												<div class="news-date">
													<div class="news-day"><?php echo date("j", strtotime($data['event_date'])); ?> </div>
													<div class="news-month"><?php echo date("M", strtotime($data['event_date'])); ?></div>
													<div class="news-month"><?php echo date("Y", strtotime($data['event_date'])); ?></div>
												</div>
												<div class="news-info">
												...
												<section id="our-class-main" class="isotope">
													<?php foreach ($data1 as $row1) { ?>
														<div class="mix sport boxing element-item col-xs-12 col-sm-6 col-md-3" data-category="sport" style="padding-right: 0px; padding-left: 0px;">
															<div class="box-inner">
																<a class="example-image-link" href="bidang-admin/images/war-photo/<?php echo $row1['event_photo'] ?>" data-lightbox="example-set" data-title="">
																	<img src="bidang-admin/images/war-photo/<?php echo $row1['event_photo'] ?>" alt=""/>
																</a>
															</div>
														</div>
													<?php } ?>
