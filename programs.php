...
<head>
<title>Bidang MMA & Fitness Gym || Our Programs</title>
<!--meta info-->
<meta charset="utf-8">
		...
		<section  class="page page-category">
			...
			<div class="content-wrapper">
				...
				<div class="page-content">					
							...
							<div class="row">
								<div class="col-md-9">
									<ul>
										...
										<li><span>//</span></li>
										<li class="category-2">Our Programs</li>								
									</ul>
								</div>
							</div>	
						</div>
					...
					<section id="classes" class="classes">						
						<div class="container">						
							<div class="classes-athlete">
								<div class="classes-inner choose" style="padding-top:70px;">
														...
														<div class="block-right-info">
															<div class="about-info">
																<div class="about-details">
																	<h4 class="about-details-title">Our Mixed Martial Arts Program</h4>
																	<p>
																		We offer complete Mixed Martial Arts training or all age gatherings, for children, 
																		grown-ups and the elderly. All the styles of Martial Arts we offer are great for 
																		anyone whether they want to compete or just want to get in shape while....
																	</p>
																	<a class="button1" href="mma.php">Click Here for more details</a>
																</div>
															</div>
					...
					<!-- Athlete Class -->
					<section id="classes" class="classes" style="background-color:#ec3642;">						
						<div class="container">						
							<div class="classes-athlete">
								<div class="classes-inner choose">
									<div class="classes-content">									
										<div class="container">
											<div class="row">
												<div class="col-md-6 col-sm-12 col-xs-12" style="padding-top:30px;">
													<div class="block-right">
														<div class="block-right-info">
															<div class="about-info">
																<div class="about-details">
																	<h4 class="about-details-title" style="color:white;">Our Fitness Program</h4>
																	<p>
																	...
																	<a class="button2" href="fitness.php">Click Here for more details</a>
																</div>
															</div>
												...
												<div class="col-md-6 col-sm-12 col-xs-12" style="padding-top:30px;">
													<div class="block-left">
														<div class="about-img">
															<img src="images/fitness_1.jpg" alt=""/>
														</div>
													</div>
												</div>																																																	
											</div>
										...
										<div class="container">
											<div class="row">
												<div class="col-md-6 col-sm-12 col-xs-12">
													<div class="block-left">
														<div class="about-img">
															<img src="images/weight_management_1.jpg" alt=""/>
														</div>
													</div>
												</div>
												<div class="col-md-6 col-sm-12 col-xs-12">
													<div class="block-right">
														<div class="block-right-info">
															<div class="about-info">
																<div class="about-details">
																	<h4 class="about-details-title">Our Weight Management Program</h4>
																	<p>
																		If you're trying to manage your weight, our weight management workout plan can 
																		be very helpful. Our weight management plan consists of both cardiovascular 
																		exercise and resistance training. So, start your training today at our....
																	</p>

																	<a class="button1" href="weight-management.php">Click Here for more details</a>
																</div>
															</div>
										...
										<div class="container">
											<div class="row">
												<div class="col-md-6 col-sm-12 col-xs-12" style="padding-top:30px;">
													<div class="block-right">
														<div class="block-right-info">
															<div class="about-info">
																<div class="about-details">
																	<h4 class="about-details-title" style="color:white;">Our Self Defense Program</h4>
																	<p>
																		We offer self-defense training for both men and women combine both fitness 
																		training and martial arts, and are taught by our experienced coaches. Here 
																		we emphasize real-world functionality and a safe, graduated....
																	</p>
																	<a class="button2" href="self-defense.php">Click Here for more details</a>
																</div>
															</div>
												...
												<div class="col-md-6 col-sm-12 col-xs-12" style="padding-top:30px;">
													<div class="block-left">
														<div class="about-img">
															<img src="images/self_defense_1.jpg" alt=""/>
														</div>
													</div>
												</div>																																																	
											</div>
