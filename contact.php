...
<head>
<title>Bidang MMA & Fitness Gym || Contact Us</title>
<!--meta info-->
<meta charset="utf-8">
		...
		<section  class="page page-category contacts-us">
			...
			<div class="menu-wrap">
				...
				<ul class="nav-menu">
					...
					<li class="selected active"><a href="contact.php">Contact us</a></li>
				</ul>
			</div>
			<!--Menu Mobile-->
			<div class="content-wrapper">
				...
				<div class="page-content">					
					...
					<section id="our-team" class="our-team-page">				
										...
										<div class="headding">
											...
											<ul class="headding-content">
												...
												<li>
													...
													<div class="cont-headding">
														<h5>Telephone </h5>
														<p>+91 70860 41370 / +91 94019 24863</p>
													</div>
												</li>
											</ul>
										</div>
						...
						<center><p id="myElem" style="background-color:#141414; padding:10px; font-size:14px; color:white;">OOPS! SOMETHING WENT WRONG...</p></center>

						<?php } ?>

						<?php  if(isset($_GET['Success'])){?>

						<center><p id="myElem" style="background-color:#141414; padding:10px; font-size:14px; color:white;">YOUR MESSAGE HAS BEEN SEND SUCCESSFULLY...WE WILL GET BACK TO YOU SOON...</p></center>
						...
						<?php } ?>
													...
													<form action="contact_action.php" method="post">
														...
														<div class="form-validate-right">
															<div class="message">
																<textarea placeholder="Your Message *" rows="8" class="control" name="message" required></textarea>
															</div>
