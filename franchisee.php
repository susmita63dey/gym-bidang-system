...
<head>
<title>Bidang MMA & Fitness Gym || Franchisee</title>
<!--meta info-->
<meta charset="utf-8">
							...
							<div class="row">
								<div class="col-md-9">
									<ul>
										...
										<li><span>//</span></li>
										<li class="category-2"><a href="#">Franchisee</a></li>
									</ul>
								</div>
							</div>
						</div>
							...
							<div class="container">
								<div class="row">
									<div class="col-md-12 col-sm-12 col-xs-12">
										<div class="headding">
											<div class="headding-title" style="margin-top: 40px;">
												<h4>Bidang MMA Franchisee form</h4>
										...
										<section class="form-comment">
													...
													<p id="myElem" style="background-color:#141414; padding:10px; font-size:14px; color:white; width: 100%;">OOPS! SOMETHING WENT WRONG...</p>

													<?php } ?>

													<?php  if(isset($_GET['Success'])){?>

													<p id="myElem" style="background-color:#141414; padding:10px; font-size:14px; color:white; width: 100%;">YOUR MESSAGE HAS BEEN SEND SUCCESSFULLY...WE WILL GET BACK TO YOU SOON...</p>

													<?php } ?>
													<form id="" action="franchisee_action.php" class="" method="post">
														...
														<div class="form-validate-right">
															<div class="message">
																<textarea placeholder="Your Message" rows="8" class="control" id="message" name="message"></textarea>
															</div>
															<div class="form-submit">
																<input type="submit" value="Submit Comment" class="btn-submit" name="submit">
															</div>
														</div>	
													</form>
												</section>
			...
			<section>
				<div class="container">
					<div class="row">
						...
						<div class="col-md-2 col-sm-6 col-xs-12 links-our-product">							
						...
						<div class="col-md-4 col-sm-4 col-xs-12 location">							
							...
							<div class="address">
								<p>DD Complex 2, Second Floor, Sundarpur,<br>RG Baruah Road Gauhati</p>
								<p>Jkon Building, Opp. Sonaram School,<br>Bharalumukh, Guwahati</p>
								<p>Gym Khanna, Sarab Bhatti Chariali,<br>Guwahati</p>
							</div>
						</div>
