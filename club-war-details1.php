...
<head>
<title>Bidang MMA & Fitness Gym || Bidang Club Wars Details</title>
<!--meta info-->
<meta charset="utf-8">
				...
				<ul class="nav-menu">
					...
					<li class="dropdown">
						...
						<ul class="child-nav dropdown-nav">
							...
							<li class="selected active"><a href="club-war.php">Bidang Club War</a></li>
						</ul>
					</li>
					<li class="">
							...
							<div class="row">
								<div class="col-md-9">
									<ul>
										...
										<li><span>//</span></li>
										<li class="category-1"><a href="club-war.php">Bidang Club War</a></li>
										<li><span>//</span></li>
										<li class="category-2">Bidang Club War details</li>								
									</ul>
								</div>
							</div>	
						</div>
							...
							<div class="row">
								<div class="col-lg-9 col-md-8 col-sm-12 col-xs-12">																											
									<div class="event-listing">														
										<div class="event-content">
											<div class="img-event">
												<img src="images/bg-event.jpg" alt=""/>
											</div>
											<div class="news-item-inner">
												...
												<div class="news-info">
													...
													<div class="news-time">
														<p class="open-time">8:00 A.M- 10:00 P.M</p>				
														<p class="event-text">223 Park Avenue Rutherford, NJ 07070</p>				
													</div>
												</div>
											</div>
											<div class="event-detail">
												<p class="event-desc">
													Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut at turpis dolor. Vestibulum faucibus mi diam. Phasellus sed risus ligula. Aliquam erat volutpat
													parturient montes, nascetur ridiculus mus. Sed sed nisi ut orci feugiat adipiscing. Vestibulum porta ullamcorper commodo. Aliquam dui turpis, fringilla vel lacinia
													lacinia a, posuere vitae lacus. Vestibulum. Sed sed nisi ut orci feugiat adipiscing. Vestibulum porta ullamcorper commodo. Aliquam dui turpis, fringilla vel lacinia
													lacinia a, posuere vitae lacus. Vestibulum. Sed sed nisi ut orci feugiat adipiscing. Vestibulum porta ullamcorper commodo. Aliquam dui turpis, fringilla vel lacinia
													lacinia a, posuere vitae lacus. Vestibulum    
												</p>
											</div>
										</div>
									</div>
								...
								<div class="col-lg-3 col-md-4 col-sm-12 col-xs-12">
									<div class="sidebar-left">
										<section class="popular-event event-category">
											...
											<div id="filtering-demo">			
												<section id="our-class-main" class="isotope">
													...
													<div class="mix sport boxing element-item col-xs-12 col-sm-6 col-md-3" data-category="sport" style="padding-right: 0px; padding-left: 0px;">
														<div class="box-inner">
															<a class="example-image-link" href="images/onepage/classes-1.jpg" data-lightbox="example-set" data-title="">
																<img src="images/onepage/classes-1.jpg" alt=""/>
															</a>
														</div>										
													</div>												
													<div class="mix fitness sport element-item col-xs-12 col-sm-6 col-md-3" data-category="sport" style="padding-right: 0px; padding-left: 0px;">
														<div class="box-inner">
															<a class="example-image-link" href="images/onepage/classes-3.jpg" data-lightbox="example-set" data-title="">
													...
													<div class="mix fitness sport element-item col-xs-12 col-sm-6 col-md-3" data-category="sport" style="padding-right: 0px; padding-left: 0px;">
														<div class="box-inner">
															<a class="example-image-link" href="images/onepage/classes-9.jpg" data-lightbox="example-set" data-title="">
