...
<head>
<title>Bidang MMA & Fitness Gym || Become a Member</title>
<!--meta info-->
<meta charset="utf-8">
							...
							<div class="row">
								<div class="col-md-9">
									<ul>
										...
										<li><span>//</span></li>
										<li class="category-2"><a href="#">Become a Member</a></li>
									</ul>
								</div>
							</div>
						</div>
									...
									<div class="col-md-12 col-sm-12 col-xs-12">
										<div class="headding">
											<div class="headding-title" style="margin-top: 40px;">
												<h4>Bidang MMA Registration form</h4>
										...
										<section class="form-comment">
													<form id="form-comment" class="form-validate" method="post">
														<div class="form-validate-left">
															...
															<div class="website">
																<input type="text" placeholder="Your Mobile Number" name="website">
															</div>
															<div class="title">
