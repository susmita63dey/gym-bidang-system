...
$stmt = $DB_con->prepare("SELECT * FROM fight_league");
$stmt->execute();
$data=$stmt->fetchAll();
?>
<!doctype html>
...
<head>
<title>Bidang MMA & Fitness Gym || Bidang Fight Leagues</title>
<!--meta info-->
<meta charset="utf-8">
							...
							<div class="row">
								<div class="col-md-9">
									<ul>
										...
										<li><span>//</span></li>
										<li class="category-2">Bidang Fight Leagues</li>							
									</ul>
								</div>	
							</div>
						</div>
											...
											<div class="product-image-wrapper">
												<div class="product-content">
													<div class="product-image product-trainer">
														<a href="fight-league-details.php?fight_id=<?php echo $row['fight_id']; ?>"><img alt="" src="bidang-admin/images/league-banner/<?php echo $row['photo'] ?>"></a>
													</div>
													<a href="fight-league-details.php?fight_id=<?php echo $row['fight_id']; ?>">
														<div class="info-products">
															<div class="img-trainers">
																<div class="news-date">
																	<div class="news-day"><?php echo date("j", strtotime($row['league_date'])); ?></div>
																	<div class="news-month"><?php echo date("M", strtotime($row['league_date'])); ?></div>
																	<div class="news-month"><?php echo date("Y", strtotime($row['league_date'])); ?></div>
																</div>
															</div>
																...
																<div class="icon-time">
																	...
																	<?php } else { ?>
																		<?php if($row['event_start_date']==$row['event_end_date']) { ?>
																			<?php echo date("jS F,Y", strtotime($row['event_start_date'])); ?>
																		<?php } else { ?>
																			<?php echo date("jS F,Y", strtotime($row['event_start_date'])); ?> to <?php echo date("jS F,Y", strtotime($row['event_end_date'])); ?>
																		<?php } }?>
																	</span>
																</div>
															</div>	
