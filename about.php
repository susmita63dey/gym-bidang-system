...
<head>
<title>Bidang MMA & Fitness Gym || About us</title>
<!--meta info-->
<meta charset="utf-8">
				...
				<div class="page-content">					
														...
														<div class="block-right-info">
															<div class="about-info">
																...
																<div class="about-details">
																	<h3 class="about-details-title">Why Bidang MMA</h3>
																	<p style="text-align:justify;">
																	Bidang MMA was first started in the year 2014 at Sundarpur, Guwahati by 
																	Founder and Head Coach Bhabajeet Choudhury. It is the 1st Mixed Martial 
																	Arts & Fitness Gym in Guwahati. We train Mixed Martial Arts fighters 
																	and also help individuals to stay fit and healthy. Our main aim is to 
																	provide you with the ultimate fitness experience, one that focuses on 
																	your specific fitness needs, helps you achieve the results you are 
																	after and invigorates your soul. We guarantee the highest quality 
																	equipment and training programs available, an expert coach, special 
																	amenities that are often not found in other health clubs. At present 
																	we have three branches, one at Sundarpur and others at Bharalumukh and 
																	Sarab Bhatti in Guwahati.
																	</p>
						...
						<div class="parallax-block-wrap-module auto-width">
							<div class="parallax-block bt-advance-parallax" id="parallax-block">
								...
								<div class="parallax-block-content default-pos parallax-text parallax-v2 col-md-12">									
										...
										<h1 class="training-title">FACILITIES, COACHERS AND THE BEST TRAINING PROGRAMS</h1>
					...
					<section class="our-pricing">
							...
							<div class="ch-item">	
								<div class="ch-info-wrap">
									<div class="ch-info">
										...
										<h2 style="margin-top: 40px;">OUR</h2>																
										<!-- <h3>OUR</h3> -->
									</div>
						...
						<div class="boxing-card">					
							<div class="our-price col-md-6 col-sm-6 col-xs-12">						
								<div class="image-price-right">
									<img src="images/our-price-1.jpg" alt=""/>
								</div>
								<div class="boxing-card-content">
									<h3> Mission</h3>
									<p>We will deliver innovative fitness and lifestyle programs; our friendly, professional 
										coaches will inspire and support you in your commitment to enhancing the quality of your 
										life.<br><br></p>
						...
						<div class="yoga-card">												
							<div class="our-price col-md-6 col-sm-6 col-xs-12">						
								<div class="image-price-left">
									<img alt="" src="images/our-price-4.jpg">
								</div>
								<div class="yoga-content">
									<div class="yoga-card-content">
										<h3> Vision</h3>
										<p>We want to be the best quality exclusive gym in Assam. Serving clients in 
											excellence with the highest quality in wellness techniques and knowledge 
											to change and enhance their length and quality of life.<br><br></p>
